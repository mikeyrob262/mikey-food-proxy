...
async function handleRequest(request) {
  ...
  try {
    const r = await fetch('https://api.nal.usda.gov/fdc/v1/foods/search?query=' + encodeURIComponent(q) + '&pageSize=25&dataType=Branded,Survey%20(FNDDS)&api_key=Yy7wgAGNPRsain989CHefk9qbtFSxXzkbW2ZKzoF')
